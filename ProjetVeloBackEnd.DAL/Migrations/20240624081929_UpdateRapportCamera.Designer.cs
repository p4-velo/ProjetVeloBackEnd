...
namespace ProjetVeloBackEnd.DAL.Migrations
{
    ...
    [Migration("20240624081929_UpdateRapportCamera")]
    partial class UpdateRapportCamera
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetVeloBackEnd.Entities.FavoritePlace", b =>
                {
                    b.HasBaseType("ProjetVeloBackEnd.Entities.Place");
                    ...
                    b.HasDiscriminator().HasValue("FavoritePlace");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjetVeloBackEnd.Entities.User", null)
                        .WithMany()
